"""Benchmarks: collate.SortedList vs sortedcontainers.SortedList."""
...
def run_benchmarks() -> None:
    from collate import SortedList as CList
    ...
    for n in [1000, 10_000, 100_000]:
        ...
        # add() N elements
        def add_collate(d: list[int] = data) -> None:
            sl = CList()
            for v in d:
                sl.add(v)
        ...
        bench(f"add() {n} elements", add_collate, add_sc if HAS_SC else None)
...
if __name__ == "__main__":
    print("SortedList Benchmarks: collate vs sortedcontainers")
    print("=" * 70)
    run_benchmarks()
